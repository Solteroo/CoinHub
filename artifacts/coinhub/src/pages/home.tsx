...
import { ChevronRight, MessageCircle, ArrowUpRight, ArrowDownLeft } from "lucide-react";
      ...
      <div className="p-4 space-y-6 pb-24">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4">
             <GameHomeCard 
              title="Slot Maşyn" 
              subtitle="Goýum: 10 – 100 000" 
              href="/games/slot" 
              className="bg-gradient-to-r from-purple-900/40 to-card border-purple-500/20"
            ...
            <GameHomeCard 
              ...
              subtitle="Goýum: 10 – 100 000" 
              href="/games/spin" 
              className="bg-gradient-to-r from-blue-900/40 to-card border-blue-500/20"
            ...
            <GameHomeCard 
              ...
              subtitle="Goýum: 10 – 100 000" 
              href="/games/luckybox" 
              className="bg-gradient-to-r from-amber-900/40 to-card border-amber-500/20"
...
function GameHomeCard({ title, subtitle, href, className, iconColor }: { title: string, subtitle: string, href: string, className?: string, iconColor?: string }) {
  return (
    <Link href={href}>
      <motion.div 
        whileHover={{ scale: 1.02 }}
        whileTap={{ scale: 0.98 }}
        className={cn("p-5 rounded-2xl border flex items-center justify-between cursor-pointer gold-glow transition-all", className)}
      >
        <div>
        ...
        <ChevronRight className={cn("w-6 h-6", iconColor || "text-primary/50")} />
      </motion.div>
    </Link>
  );
}
